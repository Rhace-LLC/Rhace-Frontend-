...
export default function ReservationSummary() {
  ...
  const vipExtraItems = _vipExtraItems as VipExtraItem[];
  ...
  const getSelectedTablesText = () => {
    ...
    if (selectedTables.length === 1) {
      ...
      return (t.quantity || 0) > 1 ? `${t.name} (${t.quantity})` : t.name || '';
    }
                ...
                <div className=" divide-y">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2 p-2">
                    ...
                    <TablePicker
                      ...
                      onChange={(value) => handleTable(value as TableItem)}
                    />
                    <GuestPicker
                      hideChildren
                      hideInfants
              ...
              <div className="rounded-2xl bg-white border">
                <div className=" divide-y">
                  ...
                  <div className="space-y-4 p-4">
                    ...
                    {/* Bottles Section */}
                    {bottleItems.filter((item) => (item.quantity || 0) > 0).length > 0 && (
                      <div className="space-y-4 px-2 py-3 rounded-2xl border border-[#E5E7EB] bg-[#F9FAFB]">
                        <div className="flex justify-between items-start">
