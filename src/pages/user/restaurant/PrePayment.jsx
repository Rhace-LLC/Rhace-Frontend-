...
export default function PrePaymentPage() {
  ...
  const categories =
    !booking || !booking.menus ? [] : [...new Set(booking.menus.map((meal) => meal.category))];
  return (
      ...
      <div className="max-w-4xl px-4 py-6 md:px-6 md:py-8 mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-sm">
            {booking && booking.payLater
              ? 'You’ve chosen to pay at the restaurant. A reservation fee is required to secure your booking.'
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="md:text-sm text-xs text-gray-600">
                  Payment is optional, but helps the restaurant prepare your meal ahead of time.
                  Your payment is secure & refundable according to the restaurant&apos;s
                  cancellation policy.
                </p>
              </div>
            </div>
        ...
        {booking.payLater && (
          <div className="bg-[#FFFBEB] border border-[#E0B300] rounded-2xl p-4 mb-6">
            <div className="flex gap-3">
              ...
              <div>
                <h3 className="font-medium text-xs md:text-base mb-1">Reservation Fee Required</h3>
                <p className="md:text-sm text-xs text-gray-600">
                  A reservation fee applies because no meal was selected in advance. This helps
                  secure your table.
                </p>
              </div>
            </div>
          ...
          <CardContent className="px-6">
            <div className="">
              ...
              <p className="text-gray-900 text-sm md:text-base mb-4 font-semibold">
                <span className="">Amount to pay:</span> ₦{booking.totalAmount.toLocaleString()}
              </p>
                        ...
                        .map((meal, index) => (
                          <div key={index} className="flex justify-between items-start">
                            <div className="flex-1">
                              ...
                              <p className="text-sm text-gray-600">{meal.specialRequest}</p>
                            </div>
                            <div className="text-right ml-4">
                              <p className="font-medium text-gray-900">
                                ₦{meal.price.toLocaleString()}
                              </p>
                              <p className="text-sm text-gray-600">Qty: {meal.quantity}</p>
                            </div>
                          </div>
                        ))}
                    </div>
        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
          <div className="rounded-xl p-5 max-w-md mx-4 border bg-[#FFFBEB] border-[#E0B300]">
            <h2 className="text-lg font-semibold flex items-center mb-3">
              <AlertTriangle className="size-6 inline mr-2 text-[#E0B300]" />
              Confirm Pay at Restaurant
            </h2>
            <div className="text-sm space-y-3">
              <p>You have chosen to pay at the restaurant.</p>
              <p>
                A reservation fee of <span className="font-semibold">₦1,000</span> will be required
