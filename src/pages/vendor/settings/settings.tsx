...
const SettingsIcon = () => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
    <path
      fill="currentColor"
      d="M13.3333 12.5C14.4217 12.5 15.3483 13.1958 15.6917 14.1667H16.6667C17.5 14.1667 17.5 15.8333 16.6667 15.8333H15.6917C15.3483 16.8042 14.4217 17.5 13.3333 17.5C12.245 17.5 11.3183 16.8042 10.975 15.8333H3.33333C2.5 15.8333 2.5 14.1667 3.33333 14.1667H10.975C11.3183 13.1958 12.245 12.5 13.3333 12.5Z"
    />
  </svg>
);
...
const InputWrapper = ({ label, children, required }: InputWrapperProps) => (
