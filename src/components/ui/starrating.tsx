...
const StarRating = ({ rating, onChange, size = 24, readOnly = false }: StarRatingProps) => {
      ...
      {stars.map((star) => {
        ...
        return (
          ...
          >
            ...
            <Star size={size} className="text-gray-300 absolute top-0 left-0" strokeWidth={1.5} />
            ...
            >
              <Star size={size} className="fill-[#F0AE02] text-[#F0AE02]" strokeWidth={1.5} />
            </div>
          </div>
        );
      })}
