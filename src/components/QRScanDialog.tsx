              ...
              <div className="space-y-5 rounded-3xl border bg-gray-50 p-5">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="rounded-2xl bg-white p-4 shadow-sm">
                    {reservationSummary && <reservationSummary.icon className="h-8 w-8 text-blue-600" />}
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  {reservationSummary?.label1 && (
                    <SummaryRow
                      ...
                      value={formatDate(
                        reservationSummary.date as Date | undefined
                      )}
                    />
                  )}
                  ...
                  {reservationSummary?.secondaryDate && (
                    <SummaryRow
                      ...
                      value={formatDate(
                        reservationSummary.secondaryDate as Date | undefined
                      )}
                    />
                  )}
                  ...
                  {reservationSummary?.time && (
                    <SummaryRow
                      ...
                      label="Time"
                      value={formatTime(
                        reservationSummary.time as string | undefined
                      )}
                    />
                  )}
