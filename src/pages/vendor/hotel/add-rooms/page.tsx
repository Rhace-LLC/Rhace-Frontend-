...
export default function AddRooms() {
  ...
  const handleBookingPolicySubmit = (data: Record<string, unknown>) => {
  ...
  const handleInputChange = useCallback(
    (roomId: string, field: keyof RoomTypeDraft, value: unknown) => {
      setCompleteFormData((prev) => ({
        ...prev,
  ...
  const processImages = async (images: Array<string | File>) => {
          ...
          {currentStep === 2 && (
            <div className="">
              <BookingPolicyForm
                ...
                setFormData={(update: BookingPolicyValue) =>
                  setCompleteFormData((prev) => ({
                    ...prev,
                    bookingPolicy:
