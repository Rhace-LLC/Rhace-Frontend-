...
const CreateMenu = () => {
  ...
  const steps: { title: string; icon: React.ElementType }[] = [
    {
      title: 'Menu',
      icon: DishCover,
    },
  ...
  const formattedItems = menuItems.reduce((acc: FormattedCategory[], item: any) => {
  ...
  return (
    <div className="bg-[#F9FAFB] min-h-dvh pb-16">
        ...
        <div className="flex items-center gap-4 p-3 bg-[#E7F0F0]">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-sm text-gray-500">
              <span className="mr-2">
                Menu Type: {formData.menuType.join(', ') || 'A la Carte, Buffet'}
              </span>
            ...
            {steps.map((step1, i) => (
              <div key={i} className="flex gap-6">
                <div className="flex items-center gap-2">
                  <div
                    className={`p-2.5 w-auto rounded-full ${i <= step ? 'bg-[#0A6C6D]' : 'bg-[#E5E7EB]'}`}
                  >
                    {i < step ? (
                      <Check className="size-5 text-white" />
                    ) : (
                      <step1.icon
                        className={`${i <= step ? 'text-white' : 'text-[#606368]'}`}
                        fill={i <= step ? '#fff' : '#606368'}
                      />
                    )}
                  </div>
                  <div
                    className={`text-sm font-medium ${i <= step ? 'text-[#0A6C6D]' : 'text-[#606368]'}`}
                  >
                    {step1.title}
                  </div>
                </div>
                <div
                  className={`w-16 mt-5 h-0.5 rounded-full ${i === 2 ? 'hidden' : i <= step ? 'bg-[#0A6C6D] ' : 'bg-[#606368]'}`}
                />
              </div>
            ))}
          </div>
              ...
              <div className="space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                    {['A la Carte', 'Buffet', 'Set Menu', 'Tasting Menu', 'Takeaway'].map(
                      (type) => (
                ...
                <div className="space-y-2">
                  ...
                  <RadioGroup
                    ...
                    onValueChange={() =>
                      setFormData({
                        ...formData,
                        pricingModel: formData.pricingModel === 'fixed' ? 'perItem' : 'fixed',
                      })
                    }
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <input
                      ...
                      max={5242880}
                      onChange={(e) =>
                        e.target.files && handleImageUpload(e.target.files, setFormData)
                      }
                      className="sr-only"
            ...
            >
              ...
              <div className="flex flex-col items-center w-full gap-8 justify-between mx-auto max-w-[650px]">
                <TabsList className="bg-white">
                  <TabsTrigger
                    value="exist"
                    className="data-[state=active]:bg-[#E7F0F0] data-[state=active]:border-[#B3D1D2]"
                  >
                                  ...
                                  <Checkbox
                                    ...
                                    onCheckedChange={(checked) => {
                                      if (checked) {
                                        ...
                                        setNewItem({
                                          ...newItem,
                                          mealTimes: newItem.mealTimes.filter(
                                            (item) => item !== meal
                                          ),
                                        });
                                      }
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="border-2 border-dashed border-[#E0B300] rounded-md p-4 bg-yellow-50">
                              ...
                              <div className="text-xs text-gray-600 mt-1">
                                Current menu - Item will be displayed here
                              </div>
                            </div>
                          </div>
                          <div className="mt-6">
                          ...
                          <div className="flex items-start flex-col gap-2">
                            <label className="flex items-center gap-2">
                              <input
                                ...
                                onChange={(e) =>
                                  setNewItem({ ...newItem, discount: e.target.checked })
                                }
                                className="h-5 w-5"
                              />
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(value) =>
                              setNewItem({ ...newItem, addOns: value as boolean })
                            }
                            id="addons-variants"
                          />
                        ...
                        <div className="flex flex-col space-y-2">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <Switch
                              ...
                              onCheckedChange={(value) =>
                                setNewItem({ ...newItem, isVisible: value })
                              }
                            />
                          </div>
                        </div>
            ...
            <Card className="p-5">
              ...
              <CardContent className="space-y-3 p-0">
                {selectedItems.map((item, idx) => (
                  <DraggableBox key={idx} isDragging={isDragging} item={item} handleClear={handleClear} />
                ))}
                <div className="pt-3">
      ...
      <div className="fixed flex justify-between bottom-0 left-0 w-full px-8 py-4 bg-white border-t">
        ...
        <DashboardButton
          onClick={handleNext}
          disabled={(selectedItems.length === 0 && step > 0 && activeTab !== 'new') || loading}
          ...
          <div className="max-w-2xl h-full bg-gray-50 flex flex-col rounded-2xl overflow-y-auto px-4 py-10">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 w-full max-w-2xl mb-8">
              <div className="p-6">
                ...
                <p className="text-sm text-gray-500 mb-4">Drag to reorder items in your menu</p>
...
const DraggableBox = ({
  ...
  return (
    <div className={`text-center rounded ${isDragging ? 'cursor-grabbing' : 'cursor-grab'}`}>
      <div
        className="border border-[#E5E7EB] bg-[#F9FAFB] h-full flex items-center rounded-md gap-3 p-3 cursor-grab"
      >
        <div>
