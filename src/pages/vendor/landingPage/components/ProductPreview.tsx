  ...
  return (
    <svg viewBox="0 0 200 150" fill="none" className="w-full h-full">
      ...
      <circle
        ...
        cy="75"
        r="10"
        fill="rgba(1,180,130,0.12)"
        stroke="rgba(1,180,130,0.25)"
        strokeWidth="1.5"
      />
      ...
      <line
        ...
        x2="150"
        y2="75"
        stroke="rgba(1,180,130,0.3)"
        strokeWidth="2"
        strokeDasharray="5 4"
        strokeLinecap="round"
      />
      <path
        d="M145 70 L155 75 L145 80"
        stroke="rgba(1,180,130,0.5)"
        strokeWidth="2"
        strokeLinecap="round"
      ...
      {[0, 1, 2, 3].map((i) => (
        <g key={i}>
          <rect
            ...
            stroke={i === 0 ? 'rgba(1,180,130,0.2)' : 'rgba(255,255,255,0.06)'}
            strokeWidth="1"
          />
          <circle cx="32" cy={27 + i * 30} r="5" fill={`rgba(1,180,130,${0.6 - i * 0.12})`} />
          <rect
            x="44"
            y={22 + i * 30}
            width={80 - i * 10}
  ...
  return (
    <svg viewBox="0 0 280 120" fill="none" className="w-full h-full">
      ...
      <rect
        ...
        height="64"
        rx="14"
        fill="rgba(1,180,130,0.08)"
        stroke="rgba(1,180,130,0.2)"
        strokeWidth="1"
      />
      ...
      <path
        d="M244 41 L244 31 M240 35 L244 31 L248 35"
        stroke="rgba(1,200,150,0.7)"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(135deg, rgba(255,255,255,0.06) 0%, transparent 50%, rgba(1,180,130,0.03) 100%)',
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at 60% 40%, rgba(1,180,130,0.12) 0%, transparent 70%)',
        }}
      />
      ...
      {/* Text */}
      <h3
        className="text-lg font-bold tracking-tight leading-snug mb-1.5 relative z-10"
        style={{ color: 'rgba(255,255,255,0.92)' }}
      >
        {title}
      </h3>
      <p
        className="text-sm font-light leading-relaxed mb-5 relative z-10"
      ...
      {/* Illustration */}
      <div className={`w-full ${illustrationHeight} mt-auto relative z-10`}>{illustration}</div>
    </motion.div>
  );
}
