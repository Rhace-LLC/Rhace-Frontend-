import { Check, Mail, Clock, Download, MapPin, Printer } from 'lucide-react';
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 border border-white/50 shadow-xl hover:shadow-2xl transition-all">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2 text-sm">
                ...
                <span>Check-in: {formatDate(reservation.checkInDate as Date)}</span>
              </div>
              <div className="flex items-center gap-2 text-sm">
                <Clock className="w-4 h-4 text-gray-400" />
                <span>Check-out: {formatDate(reservation.checkOutDate as Date)}</span>
              </div>
            </div>
          </div>
