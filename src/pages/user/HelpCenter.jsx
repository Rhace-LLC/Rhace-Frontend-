      ...
      <div className="max-w-4xl mx-auto mt-20 py-16 px-6">
            ...
            <section key={idx}>
              ...
              <div className="space-y-6">
                {cat.faqs.map((item, i) => (
                  <div
                    key={i}
                    className="border border-secondary rounded-lg p-6 hover:shadow transition"
                  >
        ...
        <div className="mt-16 text-center">
          <p className="text-gray-500">
            Didn’t find the answer you were looking for? Reach out to us at{' '}
            <a href="mailto:support@rhace.africa" className="text-primary underline">
              support@rhace.africa
            </a>{' '}
