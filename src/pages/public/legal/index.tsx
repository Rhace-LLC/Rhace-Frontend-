 ...
 */
export default function LegalLayout({ tag, title, effective, sections, toc }: LegalLayoutProps) {
    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <main className="w-full mt-24 max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 items-start">
              ...
              <nav className="flex flex-col gap-2">
                {toc.map((item, i) => (
                  <a
                    ...
                    className={`text-sm transition-colors leading-snug py-0.5 ${
                      activeSection === i ? 'font-medium' : 'text-gray-400'
                    }`}
                    style={{
          ...
          {/* Content */}
          <div
            className={`${toc && toc.length > 0 ? 'lg:col-span-3' : 'lg:col-span-4'} flex flex-col gap-10`}
          >
