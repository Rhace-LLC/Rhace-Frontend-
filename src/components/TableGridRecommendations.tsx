import { getImagesForRestaurant, hasMultipleImages, useCarouselLogic } from '@/hooks/favorites';
...
const TableGrid = ({ title, data: restaurants }: TableGridProps) => {
...
export const TableGridTwo = ({ title, data: restaurants }: TableGridProps) => {
  const { currentIndices, handleMouseEnter, handleMouseLeave, handleDotClick } = useCarouselLogic();
  const [isLoading, setIsLoading] = useState(true);
  const navigate = useNavigate();
...
export const TableGridThree = ({ title, data: restaurants }: TableGridProps) => {
  const { currentIndices, handleMouseEnter, handleMouseLeave, handleDotClick } = useCarouselLogic();
  const [isLoading, setIsLoading] = useState(true);
