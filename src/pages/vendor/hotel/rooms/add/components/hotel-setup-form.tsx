...
export interface HotelSetupFormData {
  hotelName?: string;
  countryCode?: string;
  phoneNumber?: string;
  emailAddress?: string;
...
interface HotelSetupFormProps {
  formData: HotelSetupFormData;
  setFormData: React.Dispatch<React.SetStateAction<HotelSetupFormData>>;
}
...
export function HotelSetupForm({ formData, setFormData }: HotelSetupFormProps) {
  ...
  const handleInputChange = (field: keyof HotelSetupFormData, value: unknown) => {
