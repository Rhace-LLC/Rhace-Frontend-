      ...
      <main className="w-full mt-24 max-w-6xl mx-auto px-6 py-16">
        <div className="mb-14 border-b border-gray-100 pb-10">
          ...
          <p className="text-gray-400 text-base max-w-md leading-relaxed font-light">
            We'd love to hear from you. Reach out through any of the channels below and our team
            ...
            <div className="flex w-full flex-col gap-7">
              {[
                ...
                },
                {
                  icon: <Mail size={15} />,
                  label: 'Email',
                  value: 'hello@rhace.com',
                  href: 'mailto:hello@rhace.com',
                },
                {
                  icon: <MapPin size={15} />,
                  label: 'Address',
                ...
                <div key={label} className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    {href ? (
                      <a
                        href={href}
                        className="text-gray-700 text-sm font-medium whitespace-pre-line hover:opacity-60 transition-opacity"
                      >
                        {value}
                      </a>
                    ) : (
