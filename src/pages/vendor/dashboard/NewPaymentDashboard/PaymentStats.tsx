...
interface PaymentStatsData {
  sales: StatGroup;
  vendorRevenue: StatGroup;
  platformRevenue: StatGroup;
  paystackFees: StatGroup;
  payments: PaymentsGroup;
}

const emptyStats: PaymentStatsData = {
  sales: {
    thisWeek: 0,
    lastWeek: 0,
    change: 0,
...
const PaymentStats = () => {
  ...
  const [stats, setStats] = useState<PaymentStatsData>(emptyStats);
