...
export interface RoomFilterHandle {
  resetFilters: () => void;
}

const RoomFilter = forwardRef<RoomFilterHandle, RoomFilterProps>(
  ({ onFilterChange, view, setView }, ref) => {
  ...
  const applyFilters = (updates: Partial<RoomFilters> = {}) => {
