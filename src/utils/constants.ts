...
export type VendorTypeKey = VendorType;
...
export const TYPE_CONFIG: Record<VendorTypeKey, TypeConfigEntry> = {
  restaurant: {
    label: 'Restaurants',
    singular: 'Restaurant',
    bg: 'bg-emerald-600',
...
export const PRICE_DESC: Record<number, string> = {
  1: 'Budget',
  2: 'Moderate',
  3: 'Upscale',
  4: 'Luxury',
...
export const R_CUISINES: OptionTuple[] = [
  ['nigerian', 'Nigerian'],
...
export const R_DIETARY: OptionTuple[] = [
  ['halal', 'Halal'],
  ['vegetarian', 'Vegetarian'],
  ['vegan', 'Vegan'],
...
export const R_DINING_STYLES: OptionTuple[] = [
  ['', 'Any'],
  ['dine-in', 'Dine-in'],
  ['takeout', 'Takeout'],
  ['delivery', 'Delivery'],
...
export const R_SEATING: OptionTuple[] = [
  ['outdoor', 'Outdoor'],
...
export const R_OCCASIONS: OptionTuple[] = [
  ['romantic', 'Romantic'],
  ['birthday', 'Birthday'],
  ['business', 'Business'],
  ['group', 'Group'],
...
export const R_MEAL_TIMES: OptionTuple[] = [
  ['breakfast', 'Breakfast'],
  ['brunch', 'Brunch'],
  ['lunch', 'Lunch'],
  ['dinner', 'Dinner'],
...
export const R_RESERVATION: OptionTuple[] = [
  ['', 'Any'],
  ['free', 'Free'],
  ['deposit', 'Deposit'],
  ['prepay', 'Prepay'],
...
export const H_STAR_RATINGS: OptionTuple[] = [
  ['', 'Any'],
  ['5', '★★★★★'],
  ['4', '★★★★'],
  ['3', '★★★'],
...
export const H_PROPERTY_TYPE: OptionTuple[] = [
  ['', 'Any'],
  ['hotel', 'Hotel'],
  ['boutique', 'Boutique'],
  ['resort', 'Resort'],
...
export const H_AMENITIES: OptionTuple[] = [
  ['wifi', 'WiFi'],
  ['pool', 'Pool'],
  ['gym', 'Gym'],
  ['spa', 'Spa'],
...
export const H_MEAL_PLANS: OptionTuple[] = [
  ['', 'Any'],
  ['room-only', 'Room Only'],
...
export const H_CANCEL: OptionTuple[] = [
  ['', 'Any'],
  ['free', 'Free Cancellation'],
  ['partial', 'Partial Refund'],
  ['non-refundable', 'Non-refundable'],
];
export const H_ACCESSIBILITY: OptionTuple[] = [
  ['step-free', 'Step-free'],
  ['elevator', 'Elevator'],
...
// ─── Club filter options ──────────────────────────────────────────────────────
export const C_VENUE_TYPES: OptionTuple[] = [
  ['', 'Any'],
  ['club', 'Club'],
  ['lounge', 'Lounge'],
  ['rooftop', 'Rooftop'],
...
export const C_GENRES: OptionTuple[] = [
  ['afrobeats', 'Afrobeats'],
  ['amapiano', 'Amapiano'],
  ['house', 'House'],
  ['rnb', 'R&B'],
...
export const C_PERFORMANCES: OptionTuple[] = [
  ['dj', 'DJ'],
  ['live-band', 'Live Band'],
  ['standup', 'Stand-up'],
  ['karaoke', 'Karaoke'],
...
export const C_DRESS_CODES: OptionTuple[] = [
  ['', 'Any'],
...
export const C_AGE_POLICY: OptionTuple[] = [
  ['', 'Any'],
  ['18+', '18+'],
  ['21+', '21+'],
  ['all-ages', 'All Ages'],
];
export const C_TIMES: OptionTuple[] = [
  ['', 'Any time'],
  ['14:00', '2:00 PM'],
  ['15:00', '3:00 PM'],
  ['22:00', '10:00 PM'],
...
export const C_TABLE_TYPES: OptionTuple[] = [
  ['', 'Any Table'],
  ['standard', 'Standard'],
  ['vip', 'VIP'],
  ['booth', 'Booth'],
...
export const CHIP_LABEL_MAPS: Record<string, Record<string, string>> = {
