    ...
    <div className="fixed inset-0 z-50 lg:hidden">
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-white rounded-t-2xl max-h-[85vh] flex flex-col">
        ...
        <div className="px-4 py-3 border-t border-gray-100 bg-white shrink-0">
          ...
          >
            Show {pagination?.totalCount && pagination.totalCount > 0 ? `${pagination.totalCount} Results` : 'Results'}
          </button>
        </div>
      </div>
    </div>
 ...
 */
export const DesktopFilterSidebar = ({ filters, onChange, onClear, facets, hasFilters }: DesktopFilterSidebarProps) => (
