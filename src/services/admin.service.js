...
export const getTopVendorEarnings = (params = {}) =>
...
export const verifyVendorBankAccount = (id, data) =>
...
export const waiveReservationPenalty = (id, data) =>
...
export const getPayoutReceipt = (id) =>
...
export const getPaystackTransactions = (params) =>
  api.get('/payments/paystack/transactions', { params });
export const getPaystackTransactionStats = (params) =>
...
export const getSuccessfulPaymentsCount = (params = {}) =>
