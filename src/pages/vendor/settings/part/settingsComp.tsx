...
export const SectionCard = ({ title, onEdit, children }: SectionCardProps) => (
...
export const TabsNavigation = ({ activeTab, setActiveTab, tabs }: TabsNavigationProps) => (
...
export const ActionButtons = ({ onReset, onSave }: ActionButtonsProps) => (
