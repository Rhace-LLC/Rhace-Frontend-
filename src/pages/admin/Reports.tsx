...
const extractArray = (p: unknown): any[] => {
  ...
  const candidates = [
    ...
    pObj?.vendors,
    pObj?.list,
    (pObj?.data as Record<string, unknown> | undefined)?.data,
    (pObj?.data as Record<string, unknown> | undefined)?.items,
    (pObj?.data as Record<string, unknown> | undefined)?.results,
    (pObj?.data as Record<string, unknown> | undefined)?.docs,
    (pObj?.data as Record<string, unknown> | undefined)?.rows,
    (pObj?.data as Record<string, unknown> | undefined)?.vendors,
  ];
...
export default function Reports() {
  ...
  const [dateRange, setDateRange] = useState<ExportDateRange>({ from: undefined, to: undefined });
