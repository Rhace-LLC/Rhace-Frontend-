...
const NotFound = () => {
  return (
    ...
    >
      {/* Ambient blobs */}
      <div
        className="absolute top-0 left-0 w-[500px] h-[500px] -z-10 pointer-events-none"
        style={{
          background:
            'radial-gradient(ellipse at top left, rgba(1,107,88,0.06) 0%, transparent 65%)',
        }}
      />
      <div
        className="absolute bottom-0 right-0 w-[440px] h-[440px] -z-10 pointer-events-none"
        style={{
          background:
            'radial-gradient(ellipse at bottom right, rgba(1,120,95,0.05) 0%, transparent 65%)',
        }}
      />
        ...
        >
          <motion.div whileHover={{ scale: 1.04, y: -2 }} whileTap={{ scale: 0.96 }}>
            <Link
              ...
              style={{
                backgroundColor: '#016b58',
                boxShadow: '0 4px 16px -4px rgba(1,107,88,0.4)',
              }}
            >
              Back to Home
            </Link>
