...
const Filter2Icon = Filter2 as unknown as ReactNode;
                        ...
                        <DropdownMenuContent align="end" className="w-48">
                          <div className="p-2">
                            ...
                            <button
                              ...
                              className={`w-full text-left px-3 py-2 rounded-md hover:bg-gray-100 ${
                                selectedStatus === 'Active' ? 'bg-gray-100 font-medium' : ''
                              }`}
                            >
                            ...
                            <button
                              ...
                              className={`w-full text-left px-3 py-2 rounded-md hover:bg-gray-100 ${
                                selectedStatus === 'Inactive' ? 'bg-gray-100 font-medium' : ''
                              }`}
                            >
                              <span className="inline-flex items-center gap-2">
                            ...
                            <button
                              ...
                              className={`w-full text-left px-3 py-2 rounded-md hover:bg-gray-100 ${
                                selectedStatus === 'Out of Stock' ? 'bg-gray-100 font-medium' : ''
                              }`}
                            >
                              <span className="inline-flex items-center gap-2">
                            ...
                            <button
                              ...
                              className={`w-full text-left px-3 py-2 rounded-md hover:bg-gray-100 ${
                                selectedStatus === 'Low Stock' ? 'bg-gray-100 font-medium' : ''
                              }`}
                            >
                              <span className="inline-flex items-center gap-2">
                            ...
                            <div className="p-2">
                              {getCategoryOptions().map((cat) => (
                                <button
                                  ...
                                  className={`w-full text-left px-3 py-2 rounded-md hover:bg-gray-100 ${
                                    selectedCategory === cat.value ? 'bg-gray-100 font-medium' : ''
                                  }`}
                                >
                                  {cat.label}
                                </button>
                          ...
                          <tr key={item._id} className="hover:bg-gray-50">
                            ...
                            {selectedTab === 'drinks' && (
                              <>
                                ...
                                <td className="px-4 py-4 text-sm text-gray-900">{item.volume}</td>
                              </>
                            )}
                            ...
                            {selectedTab === 'sets' && (
                              <>
                                <td className="px-4 py-4 text-sm text-gray-900">
                                  {item.items?.reduce((acc: number, i: any) => acc + (i.quantity || 0), 0) || 0}
                                </td>
                              </>
                            )}
                            {selectedTab === 'sets' ||
