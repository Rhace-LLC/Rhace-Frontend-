...
interface AdminPaymentStatsData {
  sales: StatRow;
  vendorRevenue: StatRow;
  platformRevenue: StatRow;
  paystackFees: StatRow;
  payments: {
    completed: StatRow;
    pending: StatRow;
  };
...
const AdminPaymentStats = () => {
  ...
  const [stats, setStats] = useState<AdminPaymentStatsData | null>(null);
