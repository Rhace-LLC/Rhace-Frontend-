...
export const SearchAutocomplete = ({
  ...
  const [suggestions, setSuggestions] = useState<Record<string, SearchSuggestionItem[]>>({});
  ...
  useEffect(() => {
    const fetchSuggestions = async () => {
      ...
      try {
        ...
        const loc = JSON.parse(location as string);
  ...
  const handleRestaurantClick = (restaurant: SearchSuggestionItem) => {
            ...
            <div className="p-3">
              ...
              {Object.entries(groupedSuggestions).map(([category, restaurants]) => {
                ...
                const categoryConfig =
                  suggestionCategories[category as keyof typeof suggestionCategories] || suggestionCategories.nearby;
