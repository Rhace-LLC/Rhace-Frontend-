    ...
    <div className="min-h-screen bg-gray-50 px-4 py-6 md:px-6 md:py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-xl font-bold text-[#111827] mb-2">Your reservation is confirmed!</h1>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4 px-4">
            ...
            <div>
              ...
              <p className="font-medium text-gray-900">{data.bookingCode}</p>
            </div>
          </div>
          ...
          {data.menus.length > 0 && (
            <div>
              ...
              <ul className="divide-y divide-gray-100">
                {data.menus.map((item: any, index: number) => (
            ...
            {!data.payLater ? (
              <>
                ...
                <p className="text-sm text-gray-600">
                  <span className="font-medium text-[#37703F]">Paid</span> • Payment made at{' '}
                  {formatCustomDate(payment.paid_at)}
                </p>
              </>
            ) : (
              <>
                ...
                <p className="text-sm font-medium text-[#E0B300]">Pay at Restaurant</p>
              </>
            )}
          </div>
        </div>
