    ...
    <div className="overflow-x-hidden bg-white">
      ...
      <div className="max-w-[1100px] mx-auto px-8 pt-32 pb-24">
        ...
        <h1 className="text-[clamp(44px,7vw,88px)] font-semibold leading-[1.03] tracking-[-0.03em] text-[#0D1117] max-w-[820px]">
          Nigeria deserves better <span className="text-[#0A6C6D]">hospitality</span>{' '}
          infrastructure.
        </h1>
        <p className="mt-8 text-[18px] text-[#6B7280] leading-[1.7] max-w-[520px]">
          We built Rhace to make booking a hotel room, reserving a table, or planning a night out as
          natural as sending a message. One platform. Every occasion.
        </p>
      </div>
      ...
      <div className="bg-[#F7F7F5] py-14 px-8">
        <div className="max-w-[1100px] mx-auto grid grid-cols-1 md:grid-cols-3">
          {[
            ...
            >
              <p className="text-[42px] font-semibold tracking-tight text-[#0D1117]">{s.num}</p>
      ...
      >
        <div>
          ...
          <p className="mt-5 text-[16px] text-[#6B7280] leading-[1.8]">
            Getting a hotel room in Lagos required phone calls. Reserving a table meant showing up
            and hoping. Finding out a venue was fully booked happened at the door.
          </p>
          <p className="mt-4 text-[16px] text-[#6B7280] leading-[1.8]">
            We built Rhace because Nigerian hospitality is world-class, but the infrastructure
            behind it was not keeping pace. We set out to change that, starting with hotels,
            restaurants, and clubs.
          </p>
        </div>
        <div className="pt-3">
          <blockquote className="border-l-[3px] border-[#0A6C6D] pl-6 text-[22px] font-medium leading-[1.45] tracking-tight text-[#0D1117]">
            "The food is incredible. The hotels are beautiful. The nightlife is electric. It just
            needed to be easier to access."
          </blockquote>
          <p className="mt-4 pl-6 text-[13px] text-[#9CA3AF]">The thinking behind Rhace</p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-[#1F2937]">
            {[
              ...
              <div key={c.n} className="px-8 py-10">
                ...
                <p className="text-[14px] text-[#6B7280] leading-[1.8]">{c.body}</p>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16">
          {[
            [
              'Speed first',
              'Every second between intent and confirmation is friction. We obsess over removing it.',
            ],
            [
              'Vendor respect',
              'The businesses on Rhace are our partners, not just our inventory. Their growth is our growth.',
            ],
            [
              'Local by design',
              'Naira pricing, Nigerian time zones, local payment methods. We are not a global product patched for Nigeria.',
            ],
            [
              'Simple always wins',
              'If a feature makes the product harder to use, it does not ship. Complexity is a choice we refuse to make.',
            ],
            [
              'Honest transparency',
              'No hidden fees. No surprises at checkout. The price you see is the price you pay.',
            ],
            [
              'Relentless iteration',
              'Rhace today is not Rhace forever. We keep listening, keep shipping, keep improving.',
            ],
          ].map(([name, body]) => (
            <div
              key={name}
            ...
            >
              <span className="text-[14px] font-semibold text-[#0D1117]">{name}</span>
        ...
        >
          <div>
            ...
            <p className="mt-5 text-[16px] text-white/65 leading-[1.8]">
              Every hotel, restaurant, and club on Rhace gets a full vendor dashboard to manage
              listings, track reservations, and understand their guests.
            </p>
          </div>
          <div>
            {[
