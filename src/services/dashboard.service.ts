...
export const getDashboardKpis = async () => {
  try {
    ...
    throw new Error(e.response?.data?.message || 'Failed to fetch KPIs');
  }
};
...
export const getRecentTransactions = async () => {
  try {
    ...
    const e = error as { response?: { data?: { message?: string } } };
    throw new Error(e.response?.data?.message || 'Failed to fetch recent transactions');
  }
};
...
export const getRevenueTrends = async () => {
  try {
    ...
    const e = error as { response?: { data?: { message?: string } } };
    throw new Error(e.response?.data?.message || 'Failed to fetch revenue trends');
  }
};
...
export const getTodaysReservations = async () => {
  try {
    ...
    const e = error as { response?: { data?: { message?: string } } };
    throw new Error(e.response?.data?.message || "Failed to fetch today's reservations");
  }
};
...
export const getTopPerformingVendors = async () => {
  try {
    ...
    const e = error as { response?: { data?: { message?: string } } };
    throw new Error(e.response?.data?.message || 'Failed to fetch top performing vendors');
  }
};
