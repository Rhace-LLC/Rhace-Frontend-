...
const TABS: { val: string; label: string; icon?: (active: boolean) => ReactNode }[] = [
  { val: '', label: 'All' },
  {
    val: 'restaurant',
    label: 'Restaurants',
    icon: () => <SvgIcon className="w-3 h-3" isActive={true} />,
  },
  {
    val: 'hotel',
    label: 'Hotels',
    icon: () => <SvgIcon2 className="text-amber-200" isActive={true} />,
  },
  {
    val: 'club',
    label: 'Clubs',
    icon: () => <SvgIcon3 className="w-3 h-3" isActive={true} />,
  },
];
